...
- [5. 核心服务与模块详细设计](#5-核心服务与模块详细设计)
  ...
  - [5.6 提示词工程框架（核心基础设施）](#56-提示词工程框架核心基础设施)
    - [5.6.1 项目本质定位](#561-项目本质定位)
    - [5.6.2 两层规范性设计](#562-两层规范性设计)
    - [5.6.3 PROOF Framework（提示词规范性）](#563-proof-framework提示词规范性)
    - [5.6.4 Instructor 集成（输出规范性）](#564-instructor-集成输出规范性)
    - [5.6.5 VLM 响应格式协议（Pydantic Models）](#565-vlm-响应格式协议pydantic-models)
    - [5.6.6 提示词版本管理策略](#566-提示词版本管理策略)
    - [5.6.7 可复用性设计](#567-可复用性设计)
    - [5.6.8 实施路线图](#568-实施路线图)
    - [5.6.9 依赖管理](#569-依赖管理)
...
graph TB
    ...
    subgraph Infra["基础设施层 (Infrastructure)"]
        PromptFramework["提示词框架<br/>(PROOF Framework)"]
        VLM["VLM客户端<br/>(Instructor + Fallback)"]
